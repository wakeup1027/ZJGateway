...
var colorPicker = {
	...
	confirBtnEvent:function(e){
		...
		$("#"+colorPicker.currentInput.id).css( "background-color" , colorPicker.colorCode );
		$("#"+colorPicker.currentInput.id+"_value").attr( "value" , colorPicker.colorCode );
		colorPicker.dispose();
	},
