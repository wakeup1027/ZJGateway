    ...
    <div class="main">
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>产业布局</dt>
	        <dd><a href="gateway_settledProject.action"><span>重大落户项目</span></a></dd>
            <dd class="cur"><a href="gateway_keyindustry.action"><span>重点企业</span></a></dd>
            <dd><a href="gateway_theCountyIndustrialZone.action"><span>GIS产业地图</span></a></dd>
	     </dl>
	    ...
	    <div class="help-cont">
	      <h2><b>产业布局    >  重点企业</b></h2>
          <div class="menutop" style="margin-left: 14px;width: 87%;">
			<a href="gateway_keyIndustry.action" style="color: gray; float: right;position: absolute;margin-left: 790px;margin-top: 610px;">更多>></a>
			<div class="menutopbox" style="height: 560px;">
				<s:iterator value="#keyIndustry" status="st">
					<s:if test="#st.index<5">
						<dl>
							<dt><img src="${picture }"></dt>
							<dd><h2>${title }</h2></dd>
							<dd style="height: 40px;overflow:hidden;width: 670px;
									    word-break: break-all;
									    text-overflow: ellipsis;
									    display: -webkit-box;
									    -webkit-box-orient: vertical;
									    -webkit-line-clamp: 2;text-indent: 0.7cm;">${fieldSummary }</dd>
							<dd><a href="gateway_detailPage.action?id=${id}" target="_blank">[详细介绍]+</a></dd>
						</dl>
					</s:if>
				</s:iterator>
			</div>
