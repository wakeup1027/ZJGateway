...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:30px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:378px;}
...
.help-cont dl dt { background:url(img/icon05.png) no-repeat 0 2px; padding-left:0px; margin-bottom:5px;}
    ...
    <div class="main">
	  <div class="help clearfix">
	    <div class="help-side">
		 <dl>
	     <dt>产业布局</dt>
	        <dd class="cur"><a href="gateway_settledProject.action"><span>重大落户项目</span></a></dd>
            <dd><a href="gateway_keyindustry.action"><span>重点企业</span></a></dd>
            <dd><a href="gateway_theCountyIndustrialZone.action"><span>GIS产业地图</span></a></dd>
	     </dl>
	    ...
	    <div class="help-cont">
	      <h2><b>产业布局    >  重大落户项目</b></h2>
          <div class="menubottom" style="margin-left: 14px;width: 87%;">
			<a href="gateway_majorSettledProject.action" style="color: gray; float: right;position: absolute;margin-left: 790px;margin-top: -33px;">更多>></a>
			<div class="menubottombox">
				<s:iterator value="#majorSettledProject" status="st">
					<s:if test="#st.index<4">
						<dl>
							<dt><a href="gateway_detailPage.action?id=${id}" target="_blank"><img src="${picture }"></a></dt>
							<dd><h2><a style="color: #1C74BE;" href="gateway_detailPage.action?id=${id}" target="_blank">${title }</a></h2></dd>
							<dd style="height: 40px;overflow:hidden;width: 730px;
									    word-break: break-all;
									    text-overflow: ellipsis;
									    display: -webkit-box;
									    -webkit-box-orient: vertical;
									    -webkit-line-clamp: 2;text-indent: 0.7cm;">${fieldSummary }</dd>
						</dl>
					</s:if>
				</s:iterator>
