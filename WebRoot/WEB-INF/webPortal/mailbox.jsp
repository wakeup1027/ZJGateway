		...
		<div class="content">
			...
			<form id="form1" method="post" action="" accept-charset="UTF-8">
			 <fieldset>
           		<legend></legend>
                   <div class="row">
                   <label>姓　　名:</label><input class="txt" type="text" name="name" id="name"><span class="red">*</span>
				   <label>电子邮箱:</label><input class="txt" type="text" name="electronicMail" id="electronicMail"><span class="red">*</span>
                   </div>
                   <div class="row">
                   <label>联系电话:</label><input class="txt" type="text" name="contactPhone" id="contactPhone"><span class="red">*</span>
                   </div>
                   <div class="row">
                   <label>联系地址:</label><input class="txt" style="width:400px" type="text" name="contactAddress" id="contactAddress"><span class="red">*</span>
                   </div>
                   <div class="row">
                   <label>主　　题:</label>
				   <input name="title" id="title" class="txt" style="width:400px" type="text"><span class="red">*</span>
                   </div>
				 <div class="row">
				   <label>内　　容:</label>
				   <p>
					 	<label><textarea name="contents" id="contents" rows="6" class="txt"></textarea></label>
				   </p>
				   </div>
           </fieldset>

		   <div class="row" style="text-align:center">
			<label><input type="submit" value="提交"  class="button btn medium" onclick="addMailbox();"></label>
...
<script type="text/javascript">
    ...
    function addMailbox(){
    	if($("#name").val()==""){
	    	...
	    	$.ajax({
	    		type:"POST",
	    		url:"gateway_addMailbox.action",
	    		dataType:"json",
	    		data:{
	    			"name":$("#name").val(),
					"electronicMail":$("#electronicMail").val(),
					"contactPhone1":$("#contactPhone").val(),
