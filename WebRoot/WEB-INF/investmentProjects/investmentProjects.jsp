	...
	<div class="nav">
		<div class="navCon">
			<ul  class="menu"><div class="li_3_div"></div>
				...
				<li id="navSelect" class="li_4"><a href="gateway_investmentProjectsList.action?id=336" >招商项目</a>
					<dl class="li_3_content"  style="top: 122px; margin-left: -40%; ">
	                    <dt></dt>
	                    <s:iterator value="#investmentProjects1" status="st">
							<s:if test="#st.index<7">
								<dd>
									<a href="gateway_investmentProjectsList.action?id=${id}">
										<span>${title }</span>
									</a>
								</dd>
							</s:if>
	     ...
	     <dt>招商项目</dt>
	        <s:iterator value="#investmentProjects1" status="st">
				<s:if test="#st.index<10">
					<dd><a href="gateway_investmentProjectsList.action?id=${id}"><span>${title }</span></a></dd>
				</s:if>
			</s:iterator>
	     </dl>
