...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:30px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:500px;}
    ...
    <div class="main">
	  <div class="help clearfix">
	    <div class="help-side">
		 <dl>
	     <dt>投资环境</dt>
	        <dd class="cur"><a href="gateway_survey.action"><span>湛江开发区概况</span></a></dd>
            <dd><a href="gateway_advantage.action"><span>投资优势</span></a></dd>
            <dd><a href="gateway_cost.action"><span>投资成本</span></a></dd>
            <dd><a href="gateway_shanweiPolicy.action"><span>投资政策</span></a></dd>
            <dd><a href="gateway_economicDevelopment.action"><span>经济发展</span></a></dd>
	    ...
	    <div class="help-cont">
	      <h2><b>投资环境    >  湛江开发区概况</b></h2>
          <div class="lists" style="width: 88.5%;height: inherit;">
          	<%-- <ul>
				<a href="gateway_generalSituationOfShanwei.action" style="color: gray; float: right;position: absolute;margin-left: 60%;margin-top: -2%;">更多>></a>
				<s:iterator value="#generalSituationOfShanwei" status="st">
					<s:if test="#st.index<9">
						<div class="demo">
							<a href="gateway_detailPage.action?id=${id}" target="_blank"><img src="${picture }"></a>
							<p style="width: 194px;text-overflow: ellipsis;overflow: hidden;text-indent: 0px;white-space: nowrap;position: relative;"><a style="color: #000;font-family: "微软雅黑","宋体";" href="gateway_detailPage.action?id=${id}" target="_blank">${title }</a></p>
							<span style="width: 202px;height: 41px;overflow:hidden;margin-left: 0px;word-break: break-all;
									    text-overflow: ellipsis;
									    display: -webkit-box;
									    -webkit-box-orient: vertical;
									    -webkit-line-clamp: 2;text-indent: 0.7cm;">${fieldSummary }</span>
						</div>
					</s:if>
				</s:iterator>
			</ul> --%>
			<div class="contentTxt" style="width:99%;float: left;border: 1px solid #e9e9e9;line-height: 27px;margin-top: 7px;">
				<div class="table1">
					<h1 style="text-align: center;line-height: 80px;font-size: 20px;color: #0F4D98;">${generalSituationOfShanwei.title }</h1>
					<div style="text-align: center;color: #888;">发布时间：<fmt:formatDate  value="${generalSituationOfShanwei.releaseTime}" type="both" pattern="yyyy-MM-dd" />
								   来源：湛江经济技术开发区
					</div>
					<hr style="font-family: Simsun; font-size: medium; white-space: normal; background-color: rgb(255, 255, 255);margin-bottom: 5px;"/>
					${generalSituationOfShanwei.content }
				</div>
			</div>
          </div>
	    </div>
