	  ...
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>投资环境</dt>
	        <dd><a href="gateway_survey.action"><span>湛江开发区概况</span></a></dd>
            <dd><a href="gateway_advantage.action"><span>投资优势</span></a></dd>
            <dd class="cur"><a href="gateway_cost.action"><span>投资成本</span></a></dd>
            <dd><a href="gateway_shanweiPolicy.action"><span>投资政策</span></a></dd>
            <dd><a href="gateway_economicDevelopment.action"><span>经济发展</span></a></dd>
            <dd><a href="gateway_carrier.action"><span>载体介绍</span></a></dd>
	     </dl>
	    ...
	    <div class="help-cont">
          ...
          <div class="lists" style="width: 88.5%">
          	<ul>
				<a href="gateway_investmentCosts.action" style="color: gray; float: right;position: absolute;margin-left: 60%;margin-top: -2%;">更多>></a>
				<s:iterator value="#investmentCosts" status="st">
