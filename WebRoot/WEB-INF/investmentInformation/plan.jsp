...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:40px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:434px;}
	  ...
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>信息公开</dt>
	        <dd><a href="gateway_information.action"><span>通知公告</span></a></dd>
            <dd><a href="gateway_dataStatistical.action"><span>统计数据</span></a></dd>
            <dd class="cur"><a href="gateway_plan.action"><span>开发区规划</span></a></dd>
            <dd><a href="gateway_keyInvestment.action"><span>重点招商项目</span></a></dd>
	    ...
	    <div class="help-cont">
	      <h2><b>信息公开    >  开发区规划</b></h2>
          <div class="planning" style="margin-left: 15px;margin-top: 8px;width: 62.5%;">
			<a href="gateway_shanweiPlanning.action" style="color: gray; float: right;position: absolute;margin-left: 790px;margin-top: 367px;">更多>></a>
			<div class="planningEg" style="height: 360.5px;width: 134%;">
				<s:iterator value="#shanweiPlanning" status="st">
					<s:if test="#st.index<3">
						<dl>
							<dt><a href="gateway_detailPage.action?id=${id}" target="_blank"><img src="${picture }"></a></dt>
							<dd><h3><a style="color: #333;" href="gateway_detailPage.action?id=${id}" target="_blank">${title }</a></h3></dd>
							<dd style="height: 60px;overflow:hidden;width: 666px;
									    word-break: break-all;
									    text-overflow: ellipsis;
									    display: -webkit-box;
									    -webkit-box-orient: vertical;
									    -webkit-line-clamp: 3;text-indent: 0.7cm;">${fieldSummary }</dd>
						</dl>
					</s:if>
				</s:iterator>
			</div>
