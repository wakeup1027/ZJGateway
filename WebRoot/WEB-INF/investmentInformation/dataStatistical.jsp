...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:40px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:330px;}
    ...
    <div class="main">
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>信息公开</dt>
	        <dd><a href="gateway_information.action"><span>通知公告</span></a></dd>
            <dd class="cur"><a href="gateway_dataStatistical.action"><span>统计数据</span></a></dd>
            <dd><a href="gateway_plan.action"><span>开发区规划</span></a></dd>
            <dd><a href="gateway_keyInvestment.action"><span>重点招商项目</span></a></dd>
	     </dl>
	    ...
	    <div class="help-cont">
	      <h2><b>信息公开    >  统计数据</b></h2>
          <div class="statistical_data" style="margin-top: 8px;width: 37.5%;">
			<!-- <div class="title">统计数据</div> -->
			<div class="data_content" style="height: 270px;width: 223%;">
				<a href="gateway_statisticalData.action" style="color: gray; float: right;position: absolute;margin-left: 745px;margin-top: 250px;">更多>></a>
				<img src="${pageContext.request.contextPath}/route/images/data_bg.jpg" alt="" style="float: left;margin-right: 52px;width: 410px;margin-bottom: 10px;height: 260px;">
				<s:iterator value="#statisticalData" status="st">
				<ul>
					<s:if test="#st.index<5">
						<li style="height: 47px;overflow: hidden;text-indent: 1px;white-space: nowrap;padding-right: 115px;text-overflow: ellipsis;width: 219px;position: relative;cursor: pointer;">
							<a style="font-size: 12px;color: #666;" href="gateway_detailPage.action?id=${id}" target="_blank">${title }</a>
							<span style="position: absolute;right: 0;">[<fmt:formatDate  value="${releaseTime}" type="both" pattern="yyyy-MM-dd" />]</span>
						</li>
					</s:if>
				</ul>
				</s:iterator>
