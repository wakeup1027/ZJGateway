	...
	<div class="nav">
		<div class="navCon">
			<ul  class="menu"><div class="li_3_div"></div>
				...
				<li id="navSelect" class="li_4"><a href="gateway_information.action" >信息公开</a>
	  ...
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>信息公开</dt>
            ...
            <dd><a href="gateway_plan.action"><span>开发区规划</span></a></dd>
            <dd><a href="gateway_keyInvestment.action"><span>重点招商项目</span></a></dd>
            <dd class="cur"><a href="gateway_investmentGuide.action"><span>投资指南</span></a></dd>
	     </dl>
	     <div class="side-slider" style="top: 148px; "></div>
	    </div>
	    <div class="help-cont">
	      <h2><b>信息公开    >  投资指南</b></h2>
          <div class="Mechanism" style="margin-left: 14px;margin-top: 24px;min-width: 900px;">
			<div class="MechanismContent">
				<ul class="natit">
					<li class="NewsDetailBg" style="width: 90px;">投资目录</li>
					<li style="width: 90px;">投资流程</li>
					<li style="width: 90px;">职能部门联系</li>
				</ul>
				<div class="w1">
					<ul>
						<li>
							<div class="contentTxt" style="width:100%;float: left;border: 1px solid #e9e9e9;line-height: 27px;margin-top: 7px;">
								<div class="table1">
									<h1 style="text-align: center;line-height: 80px;font-size: 20px;color: #0F4D98;">${investmentCatalog.title }</h1>
									<div style="text-align: center;color: #888;">发布时间：<fmt:formatDate  value="${investmentCatalog.releaseTime}" type="both" pattern="yyyy-MM-dd" />
												   来源：湛江经济技术开发区
									</div>
									<style>
										table{
									...
									<hr style="font-family: Simsun; font-size: medium; white-space: normal; background-color: rgb(255, 255, 255);"/>
									${investmentCatalog.content }
					...
					<ul>
						<li>
							<div class="contentTxt" style="width:100%;float: left;border: 1px solid #e9e9e9;line-height: 27px;margin-top: 7px;">
								<div class="table1">
									<h1 style="text-align: center;line-height: 80px;font-size: 20px;color: #0F4D98;">${investmentProcess.title }</h1>
									<div style="text-align: center;color: #888;">发布时间：<fmt:formatDate  value="${investmentProcess.releaseTime}" type="both" pattern="yyyy-MM-dd" />
												   来源：湛江经济技术开发区
									</div>
									<style>
										table{
					...
					<ul>
						<li>
							<div class="contentTxt" style="width:100%;float: left;border: 1px solid #e9e9e9;line-height: 27px;margin-top: 7px;">
								<div class="table1">
									<h1 style="text-align: center;line-height: 80px;font-size: 20px;color: #0F4D98;">${functionalDepartments.title }</h1>
									<div style="text-align: center;color: #888;">发布时间：<fmt:formatDate  value="${functionalDepartments.releaseTime}" type="both" pattern="yyyy-MM-dd" />
												   来源：湛江经济技术开发区
									</div>
									<style>
										table{
