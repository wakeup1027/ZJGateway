...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:40px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:453px;}
    ...
    <div class="main">
	  <div class="help clearfix">
	    <div class="help-side">
		 <dl>
	     <dt>信息公开</dt>
	        <dd class="cur"><a href="gateway_information.action"><span>通知公告</span></a></dd>
            <dd><a href="gateway_dataStatistical.action"><span>统计数据</span></a></dd>
            <dd><a href="gateway_plan.action"><span>开发区规划</span></a></dd>
            <dd><a href="gateway_keyInvestment.action"><span>重点招商项目</span></a></dd>
	    ...
	    <div class="help-cont">
	      <h2><b>信息公开    >  通知公告</b></h2>
          <div class="ReportGuidance" style="margin-top: 8px;width: 86%;">
			<div class="TitleTip">通知公告
				<a href="gateway_notificationAnnouncement1.action" style="color: gray; float: right;position: absolute;margin-left: 660px;">更多>></a>
			</div>
				...
				<s:iterator value="#notificationAnnouncement" status="st">
					<s:if test="#st.index<10">
						<li style="position: relative;
								   ...
								   white-space: nowrap;
								   padding-right: 73px;">
								   <a style="color:#666" href="gateway_detailPage.action?id=${id}" target="_blank">${title }<span style="position: absolute;right: 0;font-size: 12px;">[<fmt:formatDate  value="${releaseTime}" type="both" pattern="yyyy-MM-dd" />]</span></a></li>
					</s:if>
				</s:iterator>
			</ul>
			<%-- <div class="page">
				<span class="page_on">1</span><span>2</span>
			</div> --%>
		</div>
	    </div>
	  </div>
