...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:30px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:433px;}
	  ...
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>信息公开</dt>
            ...
            <dd><a href="gateway_dataStatistical.action"><span>统计数据</span></a></dd>
            <dd><a href="gateway_plan.action"><span>开发区规划</span></a></dd>
            <dd class="cur"><a href="gateway_keyInvestment.action"><span>重点招商项目</span></a></dd>
            
	     </dl>
	     <div class="side-slider" style="top: 148px; "></div>
	    </div>
	    <div class="help-cont">
	      <h2><b>信息公开    >  重点招商项目</b></h2>
          <div class="Key_project" style="width: 100%;">
			<a href="gateway_keyProject.action" style="color: gray; float: right;position: absolute;margin-left: 800px;margin-top: 375px;">更多>></a>
			<div class="Key_project_content" style="height: 350px;width: 79%;margin-bottom: 30px;margin-left: 14px;margin-top: 7px;">
				<ul>
					<s:iterator value="#keyProject" status="st">
						<s:if test="#st.index<3">
							<li>
								<h1><a style="color: #333;font-size: 15px;" href="gateway_detailPage.action?id=${id}" target="_blank">${title }</a><span>[<fmt:formatDate  value="${releaseTime}" type="both" pattern="yyyy-MM-dd" />]</span></h1>
								<ul  style="height: 54px;overflow:hidden;">
								<li style=" width: 930px;
										    word-break: break-all;
										    text-overflow: ellipsis;
										    display: -webkit-box;
										    -webkit-box-orient: vertical;
										    -webkit-line-clamp: 3;">${content }</li>
								</ul>
							</li>
						</s:if>
					</s:iterator>
