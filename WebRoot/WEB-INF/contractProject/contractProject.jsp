			...
			<ul class="menu"><div class="li_3_div"></div>
				...
				<li  id="navSelect" class="li_4"><a href="gateway_contractProject.action?classification=1">招商项目</a>
					<dl class="li_3_content"  style="top: 122px; margin-left: -40%; ">
	                    ...
	                    <dd><a href="gateway_investmentProjectsList.action?id=336"><span>招商项目</span></a></dd>
	                </dl>
				</li>
    ...
    <div class="main">
	  <div class="help clearfix">
	    <div class="help-side">
		 <dl>
	     <dt>招商项目</dt>
	        <dd class="cur"><a href="gateway_contractProject.action?classification=1"><span>工业园区及基础设施</span></a></dd>
            <dd><a href="gateway_contractProject.action?classification=2"><span>农业</span></a></dd>
            <dd><a href="gateway_contractProject.action?classification=3"><span>电子信息</span></a></dd>
            <dd><a href="gateway_contractProject.action?classification=4"><span>工业制造</span></a></dd>
            <dd><a href="gateway_contractProject.action?classification=5"><span>旅游服务业</span></a></dd>
            <dd><a href="gateway_contractProject.action?classification=6"><span>服务外包</span></a></dd>
            <dd><a href="gateway_contractProject?classification=7"><span>其他</span></a></dd>
	     </dl>
	     <div class="side-slider" style="top: 148px; "></div>
	    </div>
	    <div class="help-cont">
	      <h2><b>招商项目    &gt  工业园区及基础设施</b></h2>
	      <a href="gateway_moreProjects.action?classification=1" style="color: gray; float: right;position: absolute;margin-left: 60%;margin-top: -2%;">更多>></a>
				...
				<s:iterator value="#industrialPark" status="st">
					<s:if test="#st.index<3">
						<li>
							...
							<a href="gateway_projectReading.action?id=${id }&classification=1" target="_blank" class="aHover" style="display: none;">
								<h2>${title }</h2>
								<p>${fieldSummary }</p>
							</a>
						</li>
...
<script type="text/javascript">
	...
	//给li默认加样式
	$(function (){
		$("#colorData").find("li").eq(0).addClass("color1");
		$("#colorData").find("li").eq(1).addClass("color2");
		$("#colorData").find("li").eq(2).addClass("color3");
	});
