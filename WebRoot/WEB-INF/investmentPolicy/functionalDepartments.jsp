	  ...
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>投资服务</dt>
	        <dd><a href="gateway_investmentProcessData.action"><span>投资流程</span></a></dd>
            <dd><a href="gateway_investmentCatalogData.action"><span>投资目录</span></a></dd>
            <dd class="cur"><a href="gateway_functionalDepartmentsData.action"><span>职能部门联系</span></a></dd>
            <dd><a href="gateway_fileDownload.action"><span>资料下载</span></a></dd>
	     </dl>
	     <div class="side-slider" style="top: 148px; "></div>
	    </div>
	    <div class="help-cont">
	      <h2><b>投资服务    >  职能部门联系</b></h2>
          <div class="Mechanism" style="margin-left: 14px;margin-top: 24px;min-width: 900px;">
			<div class="MechanismContent">
				<ul class="natit">
					<li class="NewsDetailBg" style="width: 90px;">职能部门联系</li>
				</ul>
				<div class="w1">
					<ul>
						<li>
							<div class="contentTxt" style="width:100%;float: left;border: 1px solid #e9e9e9;line-height: 27px;margin-top: 7px;">
								<div class="table1">
									<h1 style="text-align: center;line-height: 80px;font-size: 20px;color: #0F4D98;">${functionalDepartmentsData.title }</h1>
									<div style="text-align: center;color: #888;">发布时间：<fmt:formatDate  value="${functionalDepartmentsData.releaseTime}" type="both" pattern="yyyy-MM-dd" />
												   来源：湛江经济技术开发区
									</div>
									<style>
										table{
									...
									${functionalDepartmentsData.content }
								</div>
							</div>
						</li>
					</ul>
