...
<style type="text/css">
/*左侧帮助*/
.help { margin-bottom:30px; background:url(./route/images/help_line_shu.gif) repeat-y 220px 0; min-height:400px;}
	...
	<div class="nav">
		<div class="navCon">
			<ul  class="menu"><div class="li_3_div" style="top:95%;"></div>
				...
				<li  id="navSelect" class="li_4"><a href="gateway_supportPolicy.action" >投资服务</a>
					<dl class="li_3_content"  style="top: 122px; margin-left: 0%; ">
	                    <dt></dt>
	  ...
	  <div class="help clearfix">
	    <div class="help-side">
	     ...
	     <dt>投资服务</dt>
            ...
            <dd><a href="gateway_investmentCatalogData.action"><span>投资目录</span></a></dd>
            <dd><a href="gateway_functionalDepartmentsData.action"><span>职能部门联系</span></a></dd>
            <dd class="cur"><a href="gateway_fileDownload.action"><span>资料下载</span></a></dd>
	     </dl>
	     <div class="side-slider" style="top: 148px; "></div>
	    </div>
	    <div class="help-cont">
	      <h2><b>投资服务    >  资料下载</b></h2>
          <div class="menurightbottom" style="margin-left: 14px;width: 87%;">
			<h2 style="margin-left: 0px;">资料下载</h2>
			<a href="gateway_dataDownload.action" style="position: absolute;margin-left: 58%;margin-top: -45px;color: #808080;float: right;">更多>></a>
			<ul style="height: 290px;width: 97%;margin-top: -25px;">
				<s:iterator value="#files" status="st">
					<s:if test="#st.index<7">
						<li class="word" style="width: 85%;">
						<a style="color: #666;" href="javascript:void(0);" onclick="onLoad(${id});">${fileName }</a><span>[<fmt:formatDate  value="${releaseTime}" type="both" pattern="yyyy-MM-dd" />]</span></li>
					</s:if>
				</s:iterator>
			</ul>
		</div>
		...
		$.ajax({
			...
			success:function(result){ 
				if(result=="true"){
					...
					alert("对不起,该文件已经被删除!");
					window.location.href="gateway_fileDownload.action";
				}
			},
