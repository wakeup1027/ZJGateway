    ...
    var methods = {
        ...
        */
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
            ...
            /*lifamin 2013.3.15 修复i6 select组件层级bug*/
            if($('input[name=isIe6]').val()){
			prompt.append("<iframe src=\"#\" frameborder=\"0\" style=\"height:50px; width:100px;z-index:-1; position:absolute; left:0; top:0;\"></iframe>")
			}
        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topRight":
                    ...
                    break;
                case "topLeft":
                    promptTopPosition += -promptHeight - 20;
                    break;
                case "centerRight":
